...
<p id="scope-help">Selected folders include complete Git metadata and unfinished work, including secrets stored inside them. Leave this empty to migrate Codex state only. Nothing outside your selection and supported Codex state is automatically included.</p>
