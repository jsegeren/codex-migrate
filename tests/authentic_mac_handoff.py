...
def shared_diagnostic(state):
    ...
    signatures = {
        ...
        'backup_comparison_incomplete': 'backup verification could not complete',
        'backup_comparison_differences': 'backup verification found differences',
        'backup_receipt_missing': 'destination backup verification receipt is missing',
