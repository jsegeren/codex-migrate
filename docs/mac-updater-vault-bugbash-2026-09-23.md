...
2. The rebuilt clean-source app, rotation DMG, Sparkle signature, private
   ...
   a live release-catalog entry. Verify the automatic idle-install path and
