...
| --- | --- | --- |
| Python regression | The merged `main` at `e2cd00c` ran 827 tests: 815 passed, 12 skipped. | Opt-in physical filesystem and clean-account tests are separate; a green unit suite is not buyer acceptance. |
